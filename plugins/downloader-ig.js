...
let txt1 = `🔰 𝙐𝙍𝙇: ${shortUrl1}`.trim()
await conn.sendFile(m.chat, videoig, 'error.mp4', txt1, m)
} catch {
return conn.reply(m.chat, '⚠️ 𝘽𝙀𝘽𝙀 𝙊𝘾𝙐𝙍𝙍𝙄𝙊 𝙐𝙉 𝙀𝙍𝙍𝙊𝙍', m, fake, )
}}}}} 
