...
mobile: MethodMobile, 
browser: opcion == '1' ? ['KimBot-MD', 'Safari', '2.0.0'] : methodCodeQR ? ['KimBot-MD', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
let prekey = []
let directorio = readdirSync("./KimBotSession")
let filesFolderPreKeys = directorio.filter(file => {
return file.startsWith('pre-key-') /*|| file.startsWith('session-') || file.startsWith('sender-') || file.startsWith('app-') */
})
prekey = [...prekey, ...filesFolderPreKeys]
filesFolderPreKeys.forEach(files => {
unlinkSync(`./kimbotsession/${files}`)
})
} 
...
const directories = ['./KimBotSession/', './jadibts/']
...
conn.welcome = '╔═════ @subject ═════╗\n╟☞ *𝗕𝗜𝗘𝗡𝗩𝗘𝗡𝗜𝗗@ 𝗚𝗨𝗔𝗣@*\n╟☞ @user\n╟☞ 𝗕𝗕 𝗟𝗘𝗘 𝗟𝗔 𝗗𝗘𝗦𝗖𝗥𝗜𝗣𝗖𝗜𝗢𝗡: \n╚═══𝗞𝗶𝗺𝗕𝗼𝘁❤️‍🩹\n\n@desc';
    conn.bye = '╔══════════╗\n╟ @user\n╟☞ *-1 𝗟𝗘𝗦𝗕𝗜𝗔𝗡𝗔*\n╟☞ *𝙇𝙤 𝙑𝙞𝙤𝙡𝙤 𝙎𝙪 𝙏𝙞𝙤🤑 𝙉𝙤 𝙏𝙚 𝙀𝙭𝙩𝙧𝙖𝙣̃𝙖𝙧𝙚𝙢𝙤𝙨*\n╚═══𝗞𝗶𝗺𝗕𝗼𝘁❤️‍🩹';
